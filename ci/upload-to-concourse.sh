...
fly -t "$CONCOURSE_TARGET" validate-pipeline -c pipeline-plain.yml
fly -t "$CONCOURSE_TARGET" set-pipeline -p haproxy-boshrelease -c pipeline-plain.yml --load-vars-from vars.yml
